...
// setter
    person["age"]=40; //This is index notation
...
console.log('------ STUDENT ACTIVITY - ANSWERS BELOW ----------');
    ...
    student = {schoolName:"Full Sail",
               address:"123 University Ave",
               studentCount:16000,
               students:[
                           {name:"James Bond", gpa:3.9, classes:["PWA1","PWA2"]},
                           {name:"B", gpa:2.9, classes:["PWA3","PWA4"]},
                           {name:"C", gpa:1.9, classes:["PWA5","PWA6"]}
                        ]

              };

    console.log(student["schoolName"]); //index syntax
    console.log(student.schoolName);    //dot syntax

    var newCnt = "studentCount";
    console.log(student[newCnt]);

    //This is index syntax
    var fieldName1 = "address";
    console.log(student[fieldName1]);


    console.log(student.students[0].gpa);
    console.log(student["students"][0]["gpa"]);
...
----------------------------------------------------------------------------- */
    ...
    var gradeAvg = function(student){
        count=0;
        total=0;
        for(var i= 0, j = student.students.length; i < j; i++){
            count++;
...
*/
    ...
    for(var key in students){
        ...
        console.log("Valus of the key[",key,"] : ", students[key]);
    };
...
// #3 - shows and array of objects, inside of an object length
    ...
    console.log("number of object field", student.students.length);
...
// showing a function call and creating a method
    ...
    //Running function and tag in the method name
